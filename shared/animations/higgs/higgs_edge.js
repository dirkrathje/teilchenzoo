...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'higgsout',
            type:'rect',
            rect:['89','-87','auto','auto','auto','auto']
         }],
         symbolInstances: [
         {
            id:'higgsout',
   ...
   states: {
      "Base State": {
         ...
         "${_higgsout}": [
            ["style", "top", '14px'],
            ["style", "left", '17px'],
            ["transform", "scaleY", '0.60244'],
            ["transform", "scaleX", '0.60244']
         ]
      }
   },
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid189", tween: [ "style", "${_higgsout}", "left", '17px', { fromValue: '17px'}], position: 3631, duration: 0 },
            { id: "eid183", tween: [ "transform", "${_higgsout}", "scaleX", '0.60244', { fromValue: '0.60244'}], position: 3631, duration: 0 },
            { id: "eid190", tween: [ "style", "${_higgsout}", "top", '14px', { fromValue: '14px'}], position: 3631, duration: 0 },
            { id: "eid184", tween: [ "transform", "${_higgsout}", "scaleY", '0.60244', { fromValue: '0.60244'}], position: 3631, duration: 0 },
            { id: "eid191", trigger: [ function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['play', '${_higgsout}', [] ], ""], position: 3912 }         ]
      }
   }
},
"higgs": {
...
"higgsout": {
   ...
   dom: [
   {
      id: 'Group',
      type: 'group',
      rect: ['0px','2px','309px','266px','auto','auto'],
      c: [
      {
         id: 'bubble',
         type: 'rect',
