...
"charm_quark": {
   ...
   },
   {
      ...
      {
         transform: [[0,0],['11'],[],['1.04185','1.04185']],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid294", tween: [ "style", "${_chafoot}", "-moz-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 3311, duration: 0, easing: "easeInOutQuad" },
            { id: "eid295", tween: [ "style", "${_chafoot}", "-ms-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 3311, duration: 0, easing: "easeInOutQuad" },
            { id: "eid296", tween: [ "style", "${_chafoot}", "msTransformOrigin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 3311, duration: 0, easing: "easeInOutQuad" },
            { id: "eid297", tween: [ "style", "${_chafoot}", "-o-transform-origin", [50,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,0]}], position: 3311, duration: 0, easing: "easeInOutQuad" },
            ...
            { id: "eid298", tween: [ "style", "${_Group}", "-moz-transform-origin", [36.1,97.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.62,96.6]}], position: 3311, duration: 386, easing: "easeInOutQuad" },
            { id: "eid299", tween: [ "style", "${_Group}", "-ms-transform-origin", [36.1,97.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.62,96.6]}], position: 3311, duration: 386, easing: "easeInOutQuad" },
            { id: "eid300", tween: [ "style", "${_Group}", "msTransformOrigin", [36.1,97.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.62,96.6]}], position: 3311, duration: 386, easing: "easeInOutQuad" },
            { id: "eid301", tween: [ "style", "${_Group}", "-o-transform-origin", [36.1,97.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.62,96.6]}], position: 3311, duration: 386, easing: "easeInOutQuad" },
            ...
            { id: "eid302", tween: [ "style", "${_Group}", "-moz-transform-origin", [40.62,96.6], { valueTemplate: '@@0@@% @@1@@%', fromValue: [36.1,97.28]}], position: 4569, duration: 386, easing: "easeInOutQuad" },
            { id: "eid303", tween: [ "style", "${_Group}", "-ms-transform-origin", [40.62,96.6], { valueTemplate: '@@0@@% @@1@@%', fromValue: [36.1,97.28]}], position: 4569, duration: 386, easing: "easeInOutQuad" },
            { id: "eid304", tween: [ "style", "${_Group}", "msTransformOrigin", [40.62,96.6], { valueTemplate: '@@0@@% @@1@@%', fromValue: [36.1,97.28]}], position: 4569, duration: 386, easing: "easeInOutQuad" },
            { id: "eid305", tween: [ "style", "${_Group}", "-o-transform-origin", [40.62,96.6], { valueTemplate: '@@0@@% @@1@@%', fromValue: [36.1,97.28]}], position: 4569, duration: 386, easing: "easeInOutQuad" },
