...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'bubble',
            type:'rect',
            rect:['371','76','auto','auto','auto','auto']
         },
         {
            id:'higgs',
            type:'rect',
            rect:['89','22','auto','auto','auto','auto']
         }],
         symbolInstances: [
         {
            id:'higgs',
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid178", tween: [ "style", "${_higgs}", "top", '12px', { fromValue: '22px'}], position: 0, duration: 500, easing: "easeInElastic" },
            { id: "eid179", tween: [ "style", "${_higgs}", "top", '22px', { fromValue: '12px'}], position: 500, duration: 237 },
            { id: "eid180", trigger: [ function executeSymbolFunction(e, data) { this._executeSymbolAction(e, data); }, ['stop', '${_bubble}', [] ], ""], position: 3377 }         ]
      }
   }
},
"higgs": {
