   ...
   content: {
         ...
         },
         {
            ...
            c:[
            {
               ...
               fill:["rgba(0,0,0,0)",im+"Body3.png",'0px','0px']
            },
            {
               id:'elekleftiris3',
               type:'image',
               rect:['132px','103px','41px','36px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"elekleftiris3.png",'0px','0px']
            },
            {
               id:'elekleftleg3',
               type:'image',
               rect:['0px','207px','128px','97px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"elekleftleg3.png",'0px','0px']
            },
            {
               id:'elekleftpupil3',
               type:'image',
               rect:['153px','123px','11px','10px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"elekleftpupil3.png",'0px','0px']
            },
            {
               id:'elekmouth3',
               type:'image',
               rect:['143px','194px','90px','15px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"elekmouth3.png",'0px','0px']
            },
            {
               id:'elekrightiris3',
               type:'image',
               rect:['205px','103px','42px','35px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"elekrightiris3.png",'0px','0px']
            },
            {
               id:'elekrightleg3',
               type:'image',
               rect:['234px','221px','113px','83px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"elekrightleg3.png",'0px','0px']
            },
            {
               id:'elekrightpupil3',
               type:'image',
               rect:['217px','123px','11px','10px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"elekrightpupil3.png",'0px','0px']
            },
            {
               id:'Nasenloch3',
               type:'image',
               rect:['193px','153px','24px','22px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"Nasenloch3.png",'0px','0px']
            },
            {
               id:'Nasenloch3Copy',
               type:'image',
         ...
         },
         {
            id:'RoundRect',
            type:'rect',
            rect:['143px','137px','88px','9px','auto','auto'],
         ...
         },
         {
            id:'RoundRectCopy',
            type:'rect',
            rect:['236px','137px','85px','10px','auto','auto'],
            borderRadius:["10px","10px","10px","10px"],
            fill:["rgba(155,155,155,1.00)"],
            stroke:[0,"rgba(0,0,0,1)","none"],
            transform:[]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid7", tween: [ "style", "${_Group2}", "top", '72px', { fromValue: '72px'}], position: 539, duration: 0 },
            ...
            { id: "eid6", tween: [ "style", "${_Group2}", "left", '73px', { fromValue: '73px'}], position: 539, duration: 0 },
