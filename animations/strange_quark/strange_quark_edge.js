...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'Group',
            type:'group',
            rect:['227px','70px','308','318','auto','auto'],
            c:[
            {
               id:'strqbody',
               type:'image',
               rect:['0px','2px','267px','241px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"strqbody.png",'0px','0px']
            },
            {
               id:'strqleftarm',
               type:'image',
               rect:['54px','0px','55px','106px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"strqleftarm.png",'0px','0px']
            },
            {
               id:'strqleftleg',
               type:'image',
               rect:['31px','198px','69px','109px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"strqleftleg.png",'0px','0px']
            },
            {
               id:'strqleftpupil',
               type:'image',
               rect:['69px','115px','7px','8px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"strqleftpupil.png",'0px','0px']
            },
            {
               id:'strqrightarm',
               type:'image',
               rect:['214px','139px','94px','43px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"strqrightarm.png",'0px','0px']
            },
            {
               id:'strqrightleg',
               type:'image',
               rect:['128px','193px','70px','125px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"strqrightleg.png",'0px','0px']
            },
            {
               id:'strqrightpupil',
               type:'image',
               rect:['122px','103px','7px','8px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"strqrightpupil.png",'0px','0px']
            }]
         }],
         symbolInstances: [
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid360", tween: [ "style", "${_strqleftarm}", "-moz-transform-origin", [62.75,70.82], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.75,70.82]}], position: 250, duration: 0 },
            { id: "eid361", tween: [ "style", "${_strqleftarm}", "-ms-transform-origin", [62.75,70.82], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.75,70.82]}], position: 250, duration: 0 },
            { id: "eid362", tween: [ "style", "${_strqleftarm}", "msTransformOrigin", [62.75,70.82], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.75,70.82]}], position: 250, duration: 0 },
            { id: "eid363", tween: [ "style", "${_strqleftarm}", "-o-transform-origin", [62.75,70.82], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.75,70.82]}], position: 250, duration: 0 },
            ...
            { id: "eid364", tween: [ "style", "${_Group}", "-moz-transform-origin", [42.98,57.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.99,49.66]}], position: 3114, duration: 136 },
            { id: "eid365", tween: [ "style", "${_Group}", "-ms-transform-origin", [42.98,57.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.99,49.66]}], position: 3114, duration: 136 },
            { id: "eid366", tween: [ "style", "${_Group}", "msTransformOrigin", [42.98,57.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.99,49.66]}], position: 3114, duration: 136 },
            { id: "eid367", tween: [ "style", "${_Group}", "-o-transform-origin", [42.98,57.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.99,49.66]}], position: 3114, duration: 136 },
            ...
            { id: "eid368", tween: [ "style", "${_Group}", "-moz-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [42.98,57.03]}], position: 3250, duration: 148 },
            { id: "eid369", tween: [ "style", "${_Group}", "-ms-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [42.98,57.03]}], position: 3250, duration: 148 },
            { id: "eid370", tween: [ "style", "${_Group}", "msTransformOrigin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [42.98,57.03]}], position: 3250, duration: 148 },
            { id: "eid371", tween: [ "style", "${_Group}", "-o-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [42.98,57.03]}], position: 3250, duration: 148 },
            ...
            { id: "eid372", tween: [ "style", "${_Group}", "-moz-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.63,43.28]}], position: 6082, duration: 0 },
            { id: "eid373", tween: [ "style", "${_Group}", "-ms-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.63,43.28]}], position: 6082, duration: 0 },
            { id: "eid374", tween: [ "style", "${_Group}", "msTransformOrigin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.63,43.28]}], position: 6082, duration: 0 },
            { id: "eid375", tween: [ "style", "${_Group}", "-o-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.63,43.28]}], position: 6082, duration: 0 },
            { id: "eid140", tween: [ "style", "${_Group}", "left", '10px', { fromValue: '228px'}], position: 878, duration: 2113 },
            { id: "eid164", tween: [ "style", "${_Group}", "left", '13px', { fromValue: '10px'}], position: 3114, duration: 136 },
            { id: "eid168", tween: [ "style", "${_Group}", "left", '64px', { fromValue: '13px'}], position: 3250, duration: 148 },
            { id: "eid267", tween: [ "style", "${_Group}", "left", '291px', { fromValue: '64px'}], position: 3628, duration: 2154 },
            { id: "eid276", tween: [ "style", "${_Group}", "left", '210px', { fromValue: '291px'}], position: 6082, duration: 168 },
            { id: "eid278", tween: [ "style", "${_Group}", "left", '228px', { fromValue: '210px'}], position: 6250, duration: 120 },
            ...
            { id: "eid142", tween: [ "style", "${_Group}", "top", '63px', { fromValue: '63px'}], position: 750, duration: 0 },
            { id: "eid143", tween: [ "style", "${_Group}", "top", '63px', { fromValue: '63px'}], position: 2991, duration: 0 },
            { id: "eid165", tween: [ "style", "${_Group}", "top", '20px', { fromValue: '63px'}], position: 3114, duration: 136 },
            { id: "eid169", tween: [ "style", "${_Group}", "top", '63px', { fromValue: '20px'}], position: 3250, duration: 148 },
            { id: "eid269", tween: [ "style", "${_Group}", "top", '63px', { fromValue: '63px'}], position: 3628, duration: 0 },
            { id: "eid270", tween: [ "style", "${_Group}", "top", '63px', { fromValue: '63px'}], position: 5782, duration: 0 },
            { id: "eid272", tween: [ "style", "${_Group}", "top", '63px', { fromValue: '63px'}], position: 6082, duration: 0 },
