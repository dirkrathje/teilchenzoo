   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid362", tween: [ "style", "${_strqleftarm}", "-moz-transform-origin", [62.75,70.82], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.75,70.82]}], position: 250, duration: 0 },
            { id: "eid363", tween: [ "style", "${_strqleftarm}", "-ms-transform-origin", [62.75,70.82], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.75,70.82]}], position: 250, duration: 0 },
            { id: "eid364", tween: [ "style", "${_strqleftarm}", "msTransformOrigin", [62.75,70.82], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.75,70.82]}], position: 250, duration: 0 },
            { id: "eid365", tween: [ "style", "${_strqleftarm}", "-o-transform-origin", [62.75,70.82], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.75,70.82]}], position: 250, duration: 0 },
            ...
            { id: "eid366", tween: [ "style", "${_Group}", "-moz-transform-origin", [42.98,57.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.99,49.66]}], position: 3114, duration: 136 },
            { id: "eid367", tween: [ "style", "${_Group}", "-ms-transform-origin", [42.98,57.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.99,49.66]}], position: 3114, duration: 136 },
            { id: "eid368", tween: [ "style", "${_Group}", "msTransformOrigin", [42.98,57.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.99,49.66]}], position: 3114, duration: 136 },
            { id: "eid369", tween: [ "style", "${_Group}", "-o-transform-origin", [42.98,57.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [62.99,49.66]}], position: 3114, duration: 136 },
            ...
            { id: "eid370", tween: [ "style", "${_Group}", "-moz-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [42.98,57.03]}], position: 3250, duration: 148 },
            { id: "eid371", tween: [ "style", "${_Group}", "-ms-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [42.98,57.03]}], position: 3250, duration: 148 },
            { id: "eid372", tween: [ "style", "${_Group}", "msTransformOrigin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [42.98,57.03]}], position: 3250, duration: 148 },
            { id: "eid373", tween: [ "style", "${_Group}", "-o-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [42.98,57.03]}], position: 3250, duration: 148 },
            ...
            { id: "eid374", tween: [ "style", "${_Group}", "-moz-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.63,43.28]}], position: 6082, duration: 0 },
            { id: "eid375", tween: [ "style", "${_Group}", "-ms-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.63,43.28]}], position: 6082, duration: 0 },
            { id: "eid384", tween: [ "style", "${_Group}", "msTransformOrigin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.63,43.28]}], position: 6082, duration: 0 },
            { id: "eid385", tween: [ "style", "${_Group}", "-o-transform-origin", [40.63,43.28], { valueTemplate: '@@0@@% @@1@@%', fromValue: [40.63,43.28]}], position: 6082, duration: 0 },
