   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid1067", tween: [ "style", "${_mouth2}", "-moz-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 2034, duration: 0 },
            { id: "eid1068", tween: [ "style", "${_mouth2}", "-ms-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 2034, duration: 0 },
            { id: "eid1069", tween: [ "style", "${_mouth2}", "msTransformOrigin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 2034, duration: 0 },
            { id: "eid1070", tween: [ "style", "${_mouth2}", "-o-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 2034, duration: 0 },
            ...
            { id: "eid1071", tween: [ "style", "${_mouth}", "-moz-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 2034, duration: 0 },
            { id: "eid1072", tween: [ "style", "${_mouth}", "-ms-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 2034, duration: 0 },
            { id: "eid1073", tween: [ "style", "${_mouth}", "msTransformOrigin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 2034, duration: 0 },
            { id: "eid1074", tween: [ "style", "${_mouth}", "-o-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 2034, duration: 0 },
            ...
            { id: "eid1075", tween: [ "style", "${_fueright}", "-moz-transform-origin", [2.29,22.83], { valueTemplate: '@@0@@% @@1@@%', fromValue: [2.29,22.83]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1076", tween: [ "style", "${_fueright}", "-ms-transform-origin", [2.29,22.83], { valueTemplate: '@@0@@% @@1@@%', fromValue: [2.29,22.83]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1077", tween: [ "style", "${_fueright}", "msTransformOrigin", [2.29,22.83], { valueTemplate: '@@0@@% @@1@@%', fromValue: [2.29,22.83]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1078", tween: [ "style", "${_fueright}", "-o-transform-origin", [2.29,22.83], { valueTemplate: '@@0@@% @@1@@%', fromValue: [2.29,22.83]}], position: 4828, duration: 0, easing: "easeInQuint" },
            ...
            { id: "eid1079", tween: [ "style", "${_fuerighttop}", "-moz-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1080", tween: [ "style", "${_fuerighttop}", "-ms-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1081", tween: [ "style", "${_fuerighttop}", "msTransformOrigin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1082", tween: [ "style", "${_fuerighttop}", "-o-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 4828, duration: 0, easing: "easeInQuint" },
            ...
            { id: "eid1083", tween: [ "style", "${_fueleft}", "-moz-transform-origin", [98.74,69.7], { valueTemplate: '@@0@@% @@1@@%', fromValue: [98.74,69.7]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1084", tween: [ "style", "${_fueleft}", "-ms-transform-origin", [98.74,69.7], { valueTemplate: '@@0@@% @@1@@%', fromValue: [98.74,69.7]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1085", tween: [ "style", "${_fueleft}", "msTransformOrigin", [98.74,69.7], { valueTemplate: '@@0@@% @@1@@%', fromValue: [98.74,69.7]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1086", tween: [ "style", "${_fueleft}", "-o-transform-origin", [98.74,69.7], { valueTemplate: '@@0@@% @@1@@%', fromValue: [98.74,69.7]}], position: 4828, duration: 0, easing: "easeInQuint" },
            ...
            { id: "eid1087", tween: [ "style", "${_fuelefttop}", "-moz-transform-origin", [101,94.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [101,94.03]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1088", tween: [ "style", "${_fuelefttop}", "-ms-transform-origin", [101,94.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [101,94.03]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1089", tween: [ "style", "${_fuelefttop}", "msTransformOrigin", [101,94.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [101,94.03]}], position: 4828, duration: 0, easing: "easeInQuint" },
            { id: "eid1090", tween: [ "style", "${_fuelefttop}", "-o-transform-origin", [101,94.03], { valueTemplate: '@@0@@% @@1@@%', fromValue: [101,94.03]}], position: 4828, duration: 0, easing: "easeInQuint" },
