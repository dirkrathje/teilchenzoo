   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid242", tween: [ "transform", "${_Group}", "rotateZ", '4deg', { fromValue: '0deg'}], position: 4132, duration: 17, easing: "easeInOutBounce" },
            { id: "eid243", tween: [ "transform", "${_Group}", "rotateZ", '-2deg', { fromValue: '4deg'}], position: 4149, duration: 276, easing: "easeInOutBounce" },
            { id: "eid246", tween: [ "transform", "${_Group}", "rotateZ", '0deg', { fromValue: '-2deg'}], position: 4425, duration: 121, easing: "easeInOutBounce" },
            ...
            { id: "eid244", tween: [ "style", "${_Group}", "left", '131px', { fromValue: '137px'}], position: 4132, duration: 200, easing: "easeInOutBounce" },
            ...
            { id: "eid245", tween: [ "style", "${_Group}", "top", '98px', { fromValue: '62px'}], position: 4132, duration: 200, easing: "easeInOutBounce" },
